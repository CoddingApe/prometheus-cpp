...
/// a data race.
class PROMETHEUS_CPP_CORE_EXPORT CounterEnhanced {
 public:
  static const MetricType metric_type{MetricType::CounterEnhanced};

  /// \brief Create a counter that starts at 0.
  CounterEnhanced() = default;
...
/// Register(Registry&).
PROMETHEUS_CPP_CORE_EXPORT detail::BuilderEnhanced<CounterEnhanced>
BuildCounterEnhanced();
